...
class WP_Dialog{  
    function __construct(){
            wp_register_script( 'WP-Dialog', plugins_url('diydialog.js',__FILE__), array(), '1.1', false );
...
<?php if(get_option('scroll_bar')==""||get_option('scroll_bar')=="display"){ ?>
<p><h3>手动呼出对话框功能</h3>
...
<p><h3>开启复制版权提醒功能</h3>
    ...
    <input type="hidden" name="page_options" value="scroll_bar,display_button,copyright_warn" />
