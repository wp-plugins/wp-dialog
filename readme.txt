...
插件特色    
    ...
    3、在博客底部集成随机文章滚动推荐条，并在右侧集成手动呼出对话框按钮；
    3、当有人复制博客任何内容时，将弹出友好的版权保留提醒。    
...
详情请浏览：[http://zhangge.net/4718.html](http://zhangge.net/4718.html)
...
1. 主题禁用了wp_footer中的js输出，这种情况请使用代码部署这个功能，或者取消禁用即可;

2. 博客可能存在缓存，导致js并未及时加载，清楚缓存再试;

3. 其他未知冲突，请到插件主页留言[http://zhangge.net/4718.html](http://zhangge.net/4718.html)

若发现滚动条无法启动，可能的情况有：

1. 博客未正确加载JQuery或重复加载导致冲突，解决办法参考[http://zhangge.net/4387.html](http://zhangge.net/4387.html)
